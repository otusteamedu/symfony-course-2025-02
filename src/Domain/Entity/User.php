    ...
    PasswordAuthenticatedUserInterface
{
    ...
    /**
     * @deprecated Сущности не могут иметь такого публичного метода принципиально!
     *  Сущность получает идентификатор в момент создания и изменяться он не может на протяжении всего её жизненного цикла
     */
